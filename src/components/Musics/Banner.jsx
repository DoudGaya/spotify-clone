...
export default function Banner({ func, song }) {
    ...
    return (
            <>
                <div onMouseOver={() => func(song)} className="flex items-center group space-x-5 bg-[#525252]/70 backdrop-blur-md relative rounded-lg">
                    <div className=" h-20 w-20 flex items-center justify-center bg-gradient-to-br from bg-indigo-800 via-stone-500/70 to-stone-500/70 rounded-l-lg">
                        <img src={song.banner} alt="" className=" rounded-l-lg" srcSet="" />
                    </div>
                    <p className=" font-spotify text-lg font-semibold">{song.name}</p>
