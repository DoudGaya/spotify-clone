    ...
    return (
        ...
        <div className=" w-full bg-black border-t border-gray-800 flex py-4 px-4">
            <div className=" w-1/4 flex space-x-8 pr-10 ">
                ...
                <div className="">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 stroke-white h-6" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" >
            ...
            <div className=" w-1/4 items-center flex justify-end ">
                <div className="flex space-x-2 items-center">
                    <button>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 stroke-gray-400 hover:stroke-white h-5">
